...
STORAGE_SEED = botInfo.STORAGE_SEED
STORAGE_SEED[1] = botInfo.STORAGE_SEED[1]:upper()
STORAGE_SEED[2] = botInfo.STORAGE_SEED[2]:upper()
STORAGE_BLOCK = botInfo.STORAGE_BLOCK
STORAGE_BLOCK[1] = botInfo.STORAGE_BLOCK[1]:upper()
STORAGE_BLOCK[2] = botInfo.STORAGE_BLOCK[2]:upper()
BUY_PACK = botInfo.BUY_PACK
NAME_PACK = botInfo.NAME_PACK
ID_PACK = botInfo.ID_PACK
PRICE_PACK = botInfo.PRICE_PACK
STORAGE_PACK = botInfo.STORAGE_PACK
STORAGE_PACK[1] = botInfo.STORAGE_PACK[1]:upper()
STORAGE_PACK[2] = botInfo.STORAGE_PACK[2]:upper()
SEED_ID = botInfo.SEED_ID
BLOCK_ID = SEED_ID-1
USE_WEBHOOK = botInfo.USE_WEBHOOK
LINK_WEBHOOK = botInfo.LINK_WEBHOOK
DISCORD_ID = botInfo.DISCORD_ID
...
function dropSeed()
    ...
    if bot:isInWorld(STORAGE_SEED[1]) then
        ...
        bot:moveTo(1,0)
        sleep(500)
        bot:fastDrop(SEED_ID,inv:getItemCount(SEED_ID))
        sleep(500)
...
function dropBlock()
    ...
    if bot:isInWorld(STORAGE_BLOCK[1]) then
        ...
        bot:fastDrop(BLOCK_ID,inv:getItemCount(BLOCK_ID))
        sleep(500)
...
function dropPack()
    ...
    if bot:isInWorld(STORAGE_PACK[1]) then
        ...
        bot:fastDrop(ID_PACK[i],inv:getItemCount(ID_PACK[i]))
        sleep(500)
